...
class Jugador(threading.Thread):
    ...
    def __init__(self, socket_jugador, addr_jugador, nombre_jugador):
        super().__init__()
    ...
    def recibir_info(self):
        ...
        msg_desenc = desencriptar_datos(msg_encript)
    ...
    def enviar_info(self, msg):
        ...
        try:
            msg_encript = encriptar_mensaje(msg.encode())
...
if __name__ == "__main__":
    ...
    while True:
        ...
        jugador_thread = Jugador(socket_jugador, addr_jugador, next(x))              
